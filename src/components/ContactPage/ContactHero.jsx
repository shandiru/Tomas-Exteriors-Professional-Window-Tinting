            ...
            <form className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                    <select className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-[#F21B23] outline-none transition appearance-none bg-white cursor-pointer">
