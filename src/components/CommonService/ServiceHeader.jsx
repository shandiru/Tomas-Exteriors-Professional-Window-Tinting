    ...
    <div className="min-h-screen bg-white font-sans text-slate-900">
      ...
      <header className="px-6 py-4 max-w-7xl mt-30 mx-auto flex justify-between items-center">
        <nav className="text-xs md:text-sm text-gray-500">
          Home / <span className="hover:underline cursor-pointer">Service</span> / <span className="text-slate-900 font-medium">Service Details</span>
        </nav>
      </header>
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-6 mb-12">
          <div className="max-w-2xl">
            ...
            <p className="text-gray-600 text-lg leading-relaxed max-w-xl">
              Restore your plumbing fixtures to optimal condition. Our precise and efficient repairs 
              help conserve water and enhance the functionality of your plumbing system.
            </p>
          </div>
