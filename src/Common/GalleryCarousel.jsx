                ...
                >
                  ...
                  {/* <div className="relative h-[300px] overflow-hidden">
                    ...
                    <div className="absolute top-4 left-4">
                      <span className={`px-4 py-1.5 rounded-full text-xs font-black tracking-widest uppercase shadow-lg ${isAfter
                  ...
                  <div className="relative h-[300px] overflow-hidden group/card">
                    {/* Before Image */}
                    <img
                      src="/a4.jpg"
                    ...
                    <img
                      ...
                      className={`absolute top-0 left-0 w-full h-full object-cover transition-opacity duration-700 ${isAfter ? "opacity-100" : "opacity-0"
                        }`}
                    />
                    ...
                    <div className="absolute top-4 left-4">
                      <span
                        className={`px-4 py-1.5 rounded-full text-xs font-black tracking-widest uppercase shadow-lg ${isAfter ? "bg-[#B62025] dark:text-[#FF4B4B] text-white" : "bg-white/90 text-black"
                          }`}
                      >
                        {isAfter ? "After" : "Before"}
                      </span>
                  ...
                  <div className="p-6">
                    ...
                    <div className="grid grid-cols-2 gap-3 p-1.5 bg-gray-200 dark:bg-zinc-800 rounded-xl">
                      <button
                        ...
                        className={`py-2.5 rounded-lg text-xs font-bold transition-all duration-300 ${!isAfter
